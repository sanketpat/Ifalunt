				...
				if ($scope.photoFlag == true) {
					...
					var req = {
						...
						data : {
							...
							birthDate : $scope.myDate.toISOString().substring(
									0, 10),
							gender : $scope.male,
							bio : $scope.Bio,
							city : $scope.city
					...
					if ($scope.firstname == "" || $scope.myDate == ""
							|| $scope.male == "") {
						alert("Enter Valid Details")
					} else if ($scope.firstname == null
							|| $scope.myDate == null || $scope.male == null) {
						alert("Enter Valid Details")
					}
